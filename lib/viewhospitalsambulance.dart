...
//               hospital['Email']?.toString() ?? 'Not available'),
//             const SizedBox(height: 12),
//             _buildDetailRow(Icons.phone, 'Phone', 
//               hospital['Contact_no']?.toString() ?? 'Not available'),
//             const SizedBox(height: 12),
//             _buildDetailRow(Icons.location_city, 'Address', 
//               hospital['Address']?.toString() ?? 'Not available'),
//             const SizedBox(height: 12),
...
//                       _callHospital(hospital['Contact_no']?.toString());
//                     },
...
//                     onPressed: () {
//                       Navigator.pop(context);
//                       // Navigate to ambulance list page
//                       // Navigator.push(
//                       //   context,
//                       //   MaterialPageRoute(
//                       //     builder: (context) => AmbulanceListPage(
...
//                       //   ),
//                       // );
//                       _showSnackBar("Ambulance booking - integrate with AmbulanceListPage", Colors.blue);
//                     },
//                     icon: const Icon(Icons.ambulance, size: 18),
...
//         elevation: 0,
//         title: const Text(
//           "Nearby Hospitals with Ambulances",
...
//               const SizedBox(height: 8),
//               Text(
//                 "No hospitals with ambulances found within ${radiusKm.toStringAsFixed(0)} km radius of your location.",
//                 textAlign: TextAlign.center,
//                 style: TextStyle(color: Colors.grey[600]),
//               ),
//               const SizedBox(height: 24),
...
//                     decoration: BoxDecoration(
//                       color: index == 0 ? Colors.amber : Colors.red[700],
//                       borderRadius: BorderRadius.circular(8),
//                     ),
//                     child: Text(
//                       "#${index + 1}",
...
//                       mainAxisSize: MainAxisSize.min,
//                       children: [
//                         Icon(Icons.ambulance, size: 14, color: Colors.green[700]),
//                         const SizedBox(width: 4),
//                         Text(
//                           "Available",
//                           style: TextStyle(
